...
--
-- Host: localhost    Database: internet_tv
-- ------------------------------------------------------
...
CREATE TABLE `genres` (
  ...
  KEY `program_id` (`program_id`),
  CONSTRAINT `genres_ibfk_1` FOREIGN KEY (`channel_id`) REFERENCES `channels` (`id`),
  CONSTRAINT `genres_ibfk_2` FOREIGN KEY (`program_id`) REFERENCES `programs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rankings` (
  ...
  PRIMARY KEY (`id`),
  KEY `program_id` (`program_id`),
  CONSTRAINT `rankings_ibfk_1` FOREIGN KEY (`program_id`) REFERENCES `programs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-03  1:18:56
